function WebOrder()
{
  ...
  //Clicks the 'FindElement("#ctl00_MainContent_fmwOrder_InsertButton")' link.
  Sys.Browser().Page("http://secure.smartbearsoftware.com/samples/testcomplete15/weborders/Process.aspx").FindElement("#ctl00_MainContent_fmwOrder_InsertButton").Click();
  //Waits until the browser loads the page and is ready to accept user input.
  Sys.Browser().Page("http://secure.smartbearsoftware.com/samples/testcomplete15/weborders/Process.aspx").Wait();
